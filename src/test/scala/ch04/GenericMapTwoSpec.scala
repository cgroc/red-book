...
class GenericMapTwoSpec extends FlatSpec with Matchers {
  ...
  "map2For" should "take to options and apply the function correctly" in {
    map2For(Some(3), Some(2))((a: Int, b: Int) => a * b) shouldBe Some(6)
    map2For(Some(3), None)((a: Int, b: Int) => a * b) shouldBe None
    map2For(None, Some(2))((a: Int, b: Int) => a * b) shouldBe None
    map2For(None, None)((a: Int, b: Int) => a * b) shouldBe None
  }
